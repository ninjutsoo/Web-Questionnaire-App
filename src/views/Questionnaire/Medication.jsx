...
import { MedicineBoxOutlined, AudioOutlined } from '@ant-design/icons';

const { Title, Text } = Typography;
const { TextArea } = Input;

const Medication = forwardRef(({ questionnaire, responses }, ref) => {
    ...
    <div style={{ padding: '20px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                  ...
                  {recognition && (
                    <Button
                      ...
                      style={{
                        backgroundColor: isListening[questionKey] ? '#ff4d4f' : '#52c41a',
                        borderColor: isListening[questionKey] ? '#ff4d4f' : '#52c41a',
                        color: 'white'
                      }}
                    >
      ...
      <div style={{ 
        ...
        <Text style={{ fontSize: '16px', color: '#389e0d' }}>
          💊 Click "Save Progress" to save your medication information. Please bring all your medication bottles to your appointment for a complete review.
        </Text>
      </div>
    </div>
  );
